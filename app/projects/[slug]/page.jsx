...
/**
 * Tombol scroll ke bawah/atas pada halaman detail project.
 * Menampilkan ikon panah ke bawah/atas, dan akan scroll ke bawah/atas saat diklik.
 */
 ...
 * - Mengambil slug dari params.
 * - Mencari data project berdasarkan slug.
 * - Jika tidak ditemukan, tampilkan halaman NotFound.
 * - Jika data belum ada, tampilkan skeleton loading.
 * - Jika data ditemukan, tampilkan detail project (judul, tech, tahun, preview, code, deskripsi, gambar).
 */
function Page(props) {
