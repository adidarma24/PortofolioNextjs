...
// images
import ReactChat1 from "@/public/image/projects/web/E-Commerce/ec1.png";
import ReactChat2 from "@/public/image/projects/web/E-Commerce/ec2.png";
import ReactChat3 from "@/public/image/projects/web/E-Commerce/ec3.png";
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              A AdiShop website built with Laravel, Livewire, Filament, and
              Tailwind. Developed a modern E-Commerce platform with an admin
              panel built using Filament 3 to manage products, categories,
              brands, orders, and users. The user-facing panel supports
              registration, login, product browsing, cart management, checkout,
              and order tracking. Implemented a responsive UI with Tailwind CSS
              and real-time interactivity using Livewire 3. You can see the
              source code of this project on my github account or preview the
              project by clicking the button below.
            </p>{" "}
            <div className="mt-3">
              <Button variation="primary">
                <Link href="projects/E-Cammerce">More</Link>
              </Button>
              <Button variation="secondary">
                <a
                  href="https://github.com/adidarma24/E-Commerce1"
                  target="_blank"
